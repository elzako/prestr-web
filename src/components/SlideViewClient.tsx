...
interface SlideViewClientProps {
  slide: SlideDetail
  organization: Organization
  folderPath: string
}

export default function SlideViewClient({
  slide,
  organization,
  folderPath,
}: SlideViewClientProps) {
  ...
  const confirmDelete = async () => {
    setIsDeleting(true)
    try {
      // TODO: Implement API call to delete slide
      console.log('Deleting slide')
      await new Promise((resolve) => setTimeout(resolve, 1000)) // Simulate API call

      // Navigate back to folder
      window.location.href = `/${organization.organization_name}/${folderPath}`
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ConfirmDialog
        ...
        title="Delete slide"
        message={`Are you sure you want to delete "${slide.slide_name}"? This action cannot be undone.`}
        confirmLabel="Delete"
        variant="danger"
        loading={isDeleting}
      />
