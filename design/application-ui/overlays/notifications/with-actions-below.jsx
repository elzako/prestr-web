/**
 * @description A with actions below notification component for user alerts and messages.
 * @tags overlays, notifications, with, actions, below, tailwind-ui, component
