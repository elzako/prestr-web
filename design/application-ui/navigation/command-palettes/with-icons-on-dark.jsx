          ...
          >
            ...
            {(query === '' || filteredProjects.length > 0) && (
              ...
              >
                <li className="p-2">
                  {query === '' && (
                    <h2 className="mt-4 mb-2 px-3 text-xs font-semibold text-gray-400">
                      Recent searches
                    </h2>
                  )}
                    ...
                    {(query === '' ? recent : filteredProjects).map(
                      (project) => (
                        <ComboboxOption
                          ...
                          key={project.id}
                          value={project}
                          className="group flex cursor-default items-center rounded-md px-3 py-2 select-none data-focus:bg-sky-500 data-focus:text-white data-focus:outline-hidden"
                        >
                          <FolderIcon
