/**
 * @description A simple navigation bar component for main site navigation.
 * @tags navigation, navbars, simple, tailwind-ui, component
    ...
    <Disclosure as="nav" className="relative bg-white shadow-sm">
      ...
      <DisclosurePanel className="sm:hidden">
        <div className="space-y-1 pt-2 pb-3">
          {/* Current: "bg-sky-50 border-sky-500 text-sky-700", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700" */}
          <DisclosureButton
            as="a"
            href="#"
