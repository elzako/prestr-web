    ...
    <div className="mx-auto max-w-lg">
      <div>
        ...
        <form action="#" className="mt-6 flex">
          ...
          <button
            type="submit"
            className="ml-4 shrink-0 rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-sky-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
          >
            Send invite
          </button>
        </form>
