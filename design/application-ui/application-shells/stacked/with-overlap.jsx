/**
 * @description A stacked with overlap application shell layout for streamlined vertical organization.
 * @tags application shells, stacked, with, overlap, tailwind-ui, component
