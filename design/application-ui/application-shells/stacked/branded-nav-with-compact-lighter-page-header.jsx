/**
 * @description A stacked branded nav with compact lighter page header application shell layout for streamlined vertical organization.
 * @tags application shells, stacked, branded, nav, with, compact, lighter, page, header, tailwind-ui, component
