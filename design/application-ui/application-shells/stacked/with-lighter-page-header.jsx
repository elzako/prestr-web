/**
 * @description A stacked with lighter page header application shell layout for streamlined vertical organization.
 * @tags application shells, stacked, with, lighter, page, header, tailwind-ui, component
