        ...
        >
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              ...
              <div className="relative flex grow flex-col gap-y-5 overflow-y-auto bg-sky-600 px-6 pb-4">
                ...
                <nav className="flex flex-1 flex-col">
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    <li className="mt-auto">
                      <a
                        href="#"
                        className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-sky-200 hover:bg-sky-700 hover:text-white"
                      >
                        <Cog6ToothIcon
                          aria-hidden="true"
                          className="size-6 shrink-0 text-sky-200 group-hover:text-white"
                        />
                        Settings
                      </a>
                    </li>
