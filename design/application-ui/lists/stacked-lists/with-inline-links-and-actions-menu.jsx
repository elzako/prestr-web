/**
 * @description A with inline links and actions menu stacked list component for vertical content organization.
 * @tags lists, stacked lists, with, inline, links, and, actions, menu, tailwind-ui, component
