/**
 * @description A full width with links stacked list component for vertical content organization.
 * @tags lists, stacked lists, full, width, with, links, tailwind-ui, component
