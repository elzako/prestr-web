/**
 * @description A left aligned description list component for structured key-value data presentation.
 * @tags data display, description lists, left, aligned, tailwind-ui, component
