/**
 * @description A left aligned on dark description list component for structured key-value data presentation.
 * @tags data display, description lists, left, aligned, dark, tailwind-ui, component
