/**
 * @description A two column with cards form layout component for structured data input.
 * @tags forms, form layouts, two, column, with, cards, tailwind-ui, component
